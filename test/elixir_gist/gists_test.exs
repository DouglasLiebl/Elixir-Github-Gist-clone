defmodule ElixirGist.GistsTest do
  ...
  describe "tb_gists" do
    ...
    test "list_tb_gists/0 returns all tb_gists" do
      gist = gist_fixture()
      assert Gists.list_tb_gists() == [gist]
    end
  ...
  describe "tb_saved_gists" do
    ...
    test "list_tb_saved_gists/0 returns all tb_saved_gists" do
      saved_gist = saved_gist_fixture()
      assert Gists.list_tb_saved_gists() == [saved_gist]
    end
